window.WORDINGS = {
  ...
  genieIntrosInfinity: [
    ...
    { emoji: "🌀",             title: "Et ça continue",                subtitle: "Encore et encore." },
    { emoji: "🎤",           title: "C'est que le début",     subtitle: "D'accord, d'accord." },
    { emoji: "🔁",             title: "Surenchère infinie",            subtitle: "On n'est pas pressés." },
    ...
    { emoji: "🧠",             title: "Ça tient encore",          subtitle: "Chapeau bas." },
    { emoji: "🐔🪩",           title: "Le flan se déguise",       subtitle: "Il aime ça." },
    { emoji: "🌊",             title: "Vague après vague",         subtitle: "Tiens bon." },
    { emoji: "🐔🎩",           title: "Le flan fait des tours",    subtitle: "Magie noire." },
    { emoji: "🫥",             title: "Tu es encore là ?",         subtitle: "On commence à s'inquiéter." },
    { emoji: "🐔🔬",           title: "Étude de cas",              subtitle: "T'es une anomalie." },
    { emoji: "🌪️",             title: "Tornade de flans",          subtitle: "Pas de météo pour ça." },
    { emoji: "🐔🤝",           title: "Les poules s'organisent",   subtitle: "T'as pas l'air au courant." },
    { emoji: "🫀",             title: "Toujours en vie",           subtitle: "Pour combien de temps." },
    { emoji: "🐔🌮",           title: "Le flan s'exporte",         subtitle: "International." },
    { emoji: "🕳️",             title: "Le vide t'appelle",         subtitle: "N'y va pas." },
    { emoji: "🐔📡",           title: "Signal capté",              subtitle: "Origine inconnue." },
    { emoji: "🧊",             title: "Sang-froid absolu",         subtitle: "C'est suspect." },
    { emoji: "🐔🏆",           title: "Champion de rien",          subtitle: "Mais champion quand même." },
    { emoji: "🌈",             title: "Ça devient beau",           subtitle: "C'est mauvais signe." },
    { emoji: "🐔🌙",           title: "Le flan ne dort jamais",    subtitle: "Toi si, pourtant." },
    { emoji: "💫",             title: "Étourdissant",              subtitle: "Littéralement." },
    { emoji: "🐔⚗️",           title: "Expérience en cours",       subtitle: "Tu es le cobaye." },
    { emoji: "🫠",             title: "On commence à fondre",      subtitle: "Comme le flan." },
    { emoji: "🐔🎆",           title: "Grand final permanent",     subtitle: "Ça finit toujours." },
  ],
};
